...
| Linux | x64	| 1.7.9	| https://dl.qubic.li/downloads/qli-Client-1.7.9-Linux-x64.tar.gz	|
| Linux | x64	| 1.8.0	| https://dl.qubic.li/downloads/qli-Client-1.8.0-beta-Linux-x64.tar.gz	| Beta for newest GPU Miner
