...
|--- |---	|---	|---	|--- |
| Windows | x64	| 1.6.1	| https://dl.qubic.li/downloads/qli-Client-1.6.1-Windows-x64.zip	|
| Windows | x64	| 1.6.1	| https://dl.qubic.li/downloads/qli-Client-1.6.1-Windows-x64-Plain.zip	| Version without default configuration
| Linux | x64	| 1.6.1	| https://dl.qubic.li/downloads/qli-Client-1.6.1-Linux-x64.tar.gz	|
