...
|--- |---	|---	|--- |---	|
| Windows | x64	| 3.8.7 | https://dl.qubic.li/downloads/qli-Client-3.8.7-Windows-x64.zip  | 
| Linux | x64	| 3.8.7 | https://dl.qubic.li/downloads/qli-Client-3.8.7-Linux-x64.tar.gz | 
| Linux | arm64	| 3.8.7 | https://dl.qubic.li/downloads/qli-Client-3.8.7-Linux-arm64.tar.gz | 
| HiveOs | x64	| 3.8.7 | [HiveOs Instructions](https://github.com/qubic-li/hiveos) | 
| RaveOs | x64	| 3.8.7 | [RaveOs Instructions](https://github.com/qubic-li/raveos) | 
| mmpOs | x64	| 3.8.7 | [mmpOs Instructions](https://github.com/qubic-li/mmpos) | 
| Android | arm64	| 3.8.7 | [Android unsigned APK](http://dl.qubic.li/downloads/qli-Client-3.8.7-android-arm64.apk) | 
...
*Execute the following command to download and extract the qli-Client. This example uses the package qli-Client-3.8.7-Linux-x64.tar.gz. Please ensure you replace it with the latest available version.*  
```bash
mkdir ~/qubic;
cd ~/qubic;
wget https://dl.qubic.li/downloads/qli-Client-3.8.7-Linux-x64.tar.gz;
tar -xvf qli-Client-3.8.7-Linux-x64.tar.gz;
rm qli-Client-3.8.7-Linux-x64.tar.gz;
```  
