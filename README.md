...
|--- |---	|---	|--- |---	|
| Windows | x64	| 3.6.1 | https://dl.qubic.li/downloads/qli-Client-3.6.1-Windows-x64.zip  | 
| Linux | x64	| 3.6.1 | https://dl.qubic.li/downloads/qli-Client-3.6.1-Linux-x64.tar.gz | 
| HiveOs | x64	| 3.6.1 | [HiveOs Instructions](https://github.com/qubic-li/hiveos) | 
...
*Execute the following command to download and extract the qli-Client. This example uses the package qli-Client-3.6.1-Linux-x64.tar.gz. Please ensure you replace it with the latest available version.*  
```bash
mkdir ~/qubic;
cd ~/qubic;
wget https://dl.qubic.li/downloads/qli-Client-3.6.1-Linux-x64.tar.gz;
tar -xvf qli-Client-3.6.1-Linux-x64.tar.gz;
rm qli-Client-3.6.1-Linux-x64.tar.gz;
```  
