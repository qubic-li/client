...
|--- |---	|---	|--- |---	|
| Windows | x64	| 3.4.2 Beta | https://dl.qubic.li/downloads/qli-Client-3.4.2-Windows-x64.zip  | Includes XMR
| Windows | x64	| 3.3.9.1 | https://dl.qubic.li/downloads/qli-Client-3.3.9.1-Windows-x64.zip  | Includes XMR
| Linux | x64	| 3.4.2 Beta | https://dl.qubic.li/downloads/qli-Client-3.4.2-Linux-x64.tar.gz | Includes XMR
...
*Execute the following command to download and extract the qli-Client. This example uses the package qli-Client-3.4.2-Linux-x64.tar.gz. Please ensure you replace it with the latest available version.*  
```bash
mkdir ~/qubic;
cd ~/qubic;
wget https://dl.qubic.li/downloads/qli-Client-3.4.2-Linux-x64.tar.gz;
tar -xvf qli-Client-3.4.2-Linux-x64.tar.gz;
rm qli-Client-3.4.2-Linux-x64.tar.gz;
```  
