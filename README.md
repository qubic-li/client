...
|--- |---	|---	|---	|--- |
| Windows | x64	| 1.8.2	| https://dl.qubic.li/downloads/qli-Client-1.8.2-Windows-x64.zip	|
| Windows | x64	| 1.8.2	| https://dl.qubic.li/downloads/qli-Client-1.8.2-Windows-x64-Plain.zip	| Version without default configuration
| Linux | x64	| 1.8.2	| https://dl.qubic.li/downloads/qli-Client-1.8.2-Linux-x64.tar.gz	| 
