...
|--- |---	|---	|---	|--- |
| Windows | x64	| 1.7.5	| https://dl.qubic.li/downloads/qli-Client-1.7.5-Windows-x64.zip	|
| Windows | x64	| 1.7.5	| https://dl.qubic.li/downloads/qli-Client-1.7.5-Windows-x64-Plain.zip	| Version without default configuration
| Linux | x64	| 1.7.7	| https://dl.qubic.li/downloads/qli-Client-1.7.7-Linux-x64.tar.gz	|
