...
|--- |---	|---	|--- |---	|
| Windows | x64	| 3.0.7 BETA | https://dl.qubic.li/downloads/qli-Client-3.0.7-beta-Windows-x64.zip  | 
| Linux | x64	| 3.0.7 BETA | https://dl.qubic.li/downloads/qli-Client-3.0.7-beta-Linux-x64.tar.gz |  
| HiveOs | x64	| 3.0.7 BETA | - | not available |
